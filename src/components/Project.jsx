...
const Project = () => {
    ...
    return (
        <div className="relative  w-full px-5 lg:px-12 py-5  dark:bg-black text-black dark:text-white">
            ...
            <div
                className="grid place-content-center grid-rows-3 w-full relative  gap-2 py-12 md:grid-rows-1 md:grid-cols-2 lg:grid-cols-3 lg:grid-rows-3">
                {
                    projectItems.map((item) => (<Card key={item.id}>
                        ...
                        <div className="relative w-full z-20 mt-2">
                            ...
                            <TextExpender text={item.description} limit={100} className="text-sm"/>
                        </div>
                        <div className="relative w-full z-20 mt-2 flex-between">
                            <ButtonA href={item.liveLink}
                                     className="px-4  py-1 text-lg border-2 border-black dark:border-white-500 rounded-md hover:bg-orange text-captilize font-primary">
                                Live
                            </ButtonA>
                            <ButtonA href={item.githubLink}
                                     className="px-4  py-1  text-lg hover:border-2 border-black dark:border-white-500 rounded-md bg-orange hover:bg-transparent text-captilize font-primary">Git
                                hub</ButtonA>
                        </div>
                    </Card>))
                }
